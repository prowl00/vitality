...
import page from '@/data/colonicHydrotherapy.json';
    ...
    <>
      ...
      <main>
        ...
        <section className={`section ${s.ivory}`}>
          <div className="container">
            <FadeUpSection className={s.sectionHeader}>
              <h2 className={s.headline}>{page.basicsHeadline}</h2>
            </FadeUpSection>
            <div className={s.textBlock}>
              {page.basicsParagraphs.map(p => (
        ...
        <section className={`section ${s.linen}`}>
          <div className="container">
            <FadeUpSection className={s.sectionHeader}>
              <h2 className={s.headline}>{page.stepsHeadline}</h2>
            </FadeUpSection>
        ...
        <section className={`section ${s.ivory}`}>
          <div className="container">
            <FadeUpSection className={s.sectionHeader}>
              <h2 className={s.headline}>{page.privacyHeadline}</h2>
            </FadeUpSection>
            <div className={s.textBlock}>
              {page.privacyParagraphs.map(p => (
                <p key={p} className={s.body}>{p}</p>
              ))}
            </div>
          </div>
